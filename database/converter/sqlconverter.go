...
type DBer interface {
	...
	QueryRowContext(ctx context.Context, query string, args ...interface{}) (int64, error)
...
func (c *sqlConverter) QueryRow(query string, args ...interface{}) (int64, error) {
	var createdId int64
	err := c.db.QueryRow(query, args...).Scan(&createdId)
	if err != nil {
