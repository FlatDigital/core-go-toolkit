...
func (mock *SQLMock) QueryRow(query string, args ...interface{}) *sql.Row {
...
func (mock *SQLMock) QueryRowContext(ctx context.Context, query string, args ...interface{}) *sql.Row {
